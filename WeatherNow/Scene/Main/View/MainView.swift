                ...
                HStack {
                    ZStack(alignment: .topTrailing) {
                        ...
                        if !viewModel.isExpanded {
                            TextAnimatableValue(value: viewModel.tempC, unitOfValue: .temperature)
                                .fixedSize()
                                .foregroundColor(.white)
                    ...
                    if viewModel.isExpanded {
                        ...
                        StatusOfDayAndDateView(status: viewModel.conditionText, date: viewModel.localtimeText, isExpanded: $viewModel.isExpanded)
                            .fixedSize()
